...
class Surahbuilder extends StatefulWidget {
  ...
  final suraName;
  int ayah;
  Surahbuilder({Key? key,this.sura,this.arabic,this.suraName,required this.ayah}) : super(key: key);
...
class _SurahbuilderState extends State<Surahbuilder> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPersistentFrameCallback((_) => jumpToAyah());
    super.initState();
  }
  jumpToAyah(){
    if(fabIsClicked){
